...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tokenizer_1 = __nccwpck_require__(6936);
const tokenparser_1 = __nccwpck_require__(4715);
class JSONParser {
    constructor(opts = {}) {
...
const utf_8_1 = __nccwpck_require__(2610);
const bufferedString_1 = __nccwpck_require__(2462);
const constants_1 = __nccwpck_require__(511);
...
module.exports =
{
  parallel      : __nccwpck_require__(5663),
  serial        : __nccwpck_require__(4119),
  serialOrdered : __nccwpck_require__(8705)
};
...
var defer = __nccwpck_require__(2998);
...
var async = __nccwpck_require__(9377)
  , abort = __nccwpck_require__(9161)
  ;
...
var abort = __nccwpck_require__(9161)
  , async = __nccwpck_require__(9377)
  ;
...
var iterate    = __nccwpck_require__(1401)
  , initState  = __nccwpck_require__(2657)
  , terminator = __nccwpck_require__(1109)
  ;
...
var serialOrdered = __nccwpck_require__(8705);
...
var DelayedStream = __nccwpck_require__(7424);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(2288)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(1391);
...
var CombinedStream = __nccwpck_require__(6634);
var util = __nccwpck_require__(3837);
...
var Stream = (__nccwpck_require__(2781).Stream);
var mime = __nccwpck_require__(3338);
var asynckit = __nccwpck_require__(6118);
var populate = __nccwpck_require__(1954);
...
const JSON2CSVTransform = __nccwpck_require__(1681);
...
const lodashGet = __nccwpck_require__(3033);
const { getProp } = __nccwpck_require__(2042);
const defaultFormatter = __nccwpck_require__(5254);
const numberFormatterCtor = __nccwpck_require__(7295)
const stringFormatterCtor = __nccwpck_require__(3366);
const symbolFormatterCtor = __nccwpck_require__(9354);
const objectFormatterCtor = __nccwpck_require__(2435);
...
const JSON2CSVBase = __nccwpck_require__(1443);
...
const JSON2CSVBase = __nccwpck_require__(1443);
const { Tokenizer, TokenParser, TokenType } = __nccwpck_require__(5902);
...
const JSON2CSVStreamParser = __nccwpck_require__(4210);
const { fakeInherit } = __nccwpck_require__(2042);
...
const defaulStringFormatter = __nccwpck_require__(3366);
...
const JSON2CSVParser = __nccwpck_require__(4369);
const JSON2CSVAsyncParser = __nccwpck_require__(7270);
const JSON2CSVStreamParser = __nccwpck_require__(4210);
const JSON2CSVTransform = __nccwpck_require__(1681);

// Transforms
const flatten = __nccwpck_require__(4466);
const unwind = __nccwpck_require__(4009);

// Formatters
const defaultFormatter = __nccwpck_require__(5254);
const number = __nccwpck_require__(7295);
const string = __nccwpck_require__(3366);
const stringQuoteOnlyIfNecessary =  __nccwpck_require__(1870);
const stringExcel = __nccwpck_require__(348);
const symbol = __nccwpck_require__(9354);
const object = __nccwpck_require__(2435);
...
const lodashGet = __nccwpck_require__(3033);
const { setProp, unsetProp } = __nccwpck_require__(2042);
...
var db = __nccwpck_require__(4786)
...
const FormData$1 = __nccwpck_require__(7571);
const url = __nccwpck_require__(7310);
const proxyFromEnv = __nccwpck_require__(7884);
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const util = __nccwpck_require__(3837);
const followRedirects = __nccwpck_require__(4081);
...
(() => {
const axios = __nccwpck_require__(2360);
const json2csv = (__nccwpck_require__(8316)/* .parse */ .Qc);
